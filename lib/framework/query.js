...
function buildSqlQuery(req,query,params,cb){
    ...
    // Main query building
output.sqls.push({"datasource": datasource, "type":"main",  "query": (main + ((params.dir!== undefined && params.orderBy !== undefined) ? " order by " + params.orderBy + " " + (params.dir!==undefined ? params.dir  : " desc " ) : " ") + ((params.page!== undefined && params.rowsPerPage !== undefined) ? " limit "+((params.page - 1) * params.rowsPerPage)+","+params.rowsPerPage : "")) });

output.sqls.push({"datasource": datasource, "type":"count", "query":"select count(*) as total from ("+main+") as tempAlias"});

//    output.sqls.push({"datasource": datasource, "type":"main",  "query": (main + ((params.page!== undefined && params.rowsPerPage !== undefined) ? " limit "+params.page+","+params.rowsPerPage : "")) });
//    output.sqls.push({"datasource": datasource, "type":"count", "query":"select count(*) as total from ("+main+") as tempAlias"});
