  ...
  function buildServer(){
    var app = http.createServer(function(request,response){
      ...
      if(request.method === 'POST'){  
        ...
        waterfallProcess(obj,debugFlag);
      }
  ...
  function waterfallProcess(obj,debugFlag){
            ...
            if(err){
              ...
              query.execute(queryReq,function(err,resultObj){
                if(err){
                  ...
                  var formatObj = {"params":queryReq.search, "results" : resultObj, display: queryReq.display, joins:queryReq.joins};
