...
exports.getLogger= function (conf){
	...
	var levels= {emerg: 7,alert: 6,crit: 5,error: 4,warn: 3,notice: 2,info: 1,debug: 0  };
...
function logWrapper(logger){
  return {
      info: function(msg){
        logger.info("#"+process.pid+" "+msg);
      },
      debug: function(msg){
        logger.debug("#"+process.pid+" "+msg);
      },
      error: function(msg){
        logger.error("#"+process.pid+" "+msg);
      },
      warn: function(msg){
        logger.warn("#"+process.pid+" "+msg);
      }
  };
}
